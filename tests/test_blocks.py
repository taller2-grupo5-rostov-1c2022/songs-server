...
def test_listener_get_not_blocked_album_by_id(client):
    ...
    album_id = post_album(client, name="my_album_name", uid="artist_id", blocked=False).json()["id"]
...
def test_listener_get_blocked_album_by_id_should_fail(client):
    ...
    album_id = post_album(client, name="my_album_name", uid="artist_id", blocked=True).json()["id"]
...
def test_admin_get_album_by_id_indicates_if_album_is_blocked(client):
    ...
    album_id = post_album(client, uid="admin_id", name="not_blocked_album", blocked=True).json()["id"]
...
def test_listener_get_album_by_id_with_blocked_songs_should_retrieve_not_blocked_songs(client):
    post_user(client, uid="artist_id", user_name="artist_name")
