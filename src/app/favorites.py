...
def get_favorite_songs(
    ...
    return utils.user.get_favorite_songs(pdb, uid, role)
...
def add_song_to_favorites(
    ...
    user: models.UserModel = Depends(utils.user.get_user),
    pdb: Session = Depends(get_db),
):
    return utils.user.add_song_to_favorites(pdb, user, song)
...
def remove_song_from_favorites(
    ...
    return utils.user.remove_song_from_favorites(pdb, user, song)
...
def get_favorite_albums(
    ...
    favorite_albums = utils.user.get_favorite_albums(pdb, uid, role)
...
def add_album_to_favorites(
    ...
    return utils.user.add_album_to_favorites(pdb, user, album)
...
def remove_album_from_favorites(
    ...
    return utils.user.remove_album_from_favorites(pdb, user, album)
...
def get_favorite_playlists(
    ...
    return utils.user.get_favorite_playlists(pdb, uid, role)
...
def add_playlist_to_favorites(
    ...
    return utils.user.add_playlist_to_favorites(pdb, user, playlist)
...
def remove_playlist_from_favorites(
    ...
    return utils.user.remove_playlist_from_favorites(pdb, user, playlist)
